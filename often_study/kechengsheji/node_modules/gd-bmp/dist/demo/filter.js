...
var BMP24_1 = require("../BMP24"); // gd-bmp
var fs = require("fs");
...
function gaussBlur(img, radius, sigma) {
    ...
    var r, g, b, a;
    var i, j, k, len;
    var mradius = Math.floor(radius || 3);
    var msigma = sigma || radius / 3;
...
var srcFile = path.resolve(__dirname, '../../res/lena.bmp');
var sharpFile = path.resolve(__dirname, '../../output/sharp.bmp');
var gaussBlurFile = path.resolve(__dirname, '../../output/gaussBlur.bmp');
BMP24_1.BMP24.loadFromFile(srcFile, function (err, img) {
    if (err) {
        console.error(err);
        return;
    }
